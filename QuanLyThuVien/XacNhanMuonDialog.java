...
public class XacNhanMuonDialog extends JDialog {
    ...
    public XacNhanMuonDialog(JFrame parent, TaiKhoan admin, DocGia docGia, DefaultTableModel sachDaChonModel) {
        ...
        this.admin = admin; // <<< Dòng này bây giờ đã nhận được 'admin' từ MainFrame
        setSize(700, 600);
    ...
    private void addEventHandlers() {
        ...
        btnXacNhan.addActionListener(e -> {
            try {
                ...
                // 3. Gọi DAO để lưu
                boolean success = muonTraDAO.themMoiPhieuMuon(this.admin, this.docGia, sachMuonList, ngayMuon, ngayHenTra, loaiMuon);
